...
const Icon = ({ name, size = 22, color = C.negro, strokeWidth = 1.4 }) => {
  ...
  const p = {
    ...
    link: <><path d="M10 13.5a4 4 0 0 0 5.7.4l2.8-2.8a4 4 0 0 0-5.6-5.7l-1.3 1.3" /><path d="M14 10.5a4 4 0 0 0-5.7-.4l-2.8 2.8a4 4 0 0 0 5.6 5.7l1.3-1.3" /></>,
    ...
    folderOpen: <><path d="M3 7a2 2 0 0 1 2-2h4l2 2.5h8a2 2 0 0 1 2 2V11" /><path d="M3 9h18l-2 9.2a1 1 0 0 1-1 .8H6a1 1 0 0 1-1-.8z" /></>,
