...
const T = {
  es: {
    ...
    piCheckinNote: "Nota de check-out (dónde dejar la tarjeta o llave y el costo de reposición si no se devuelve)",
    ...
    ckInstructions: "Instrucciones de llegada", ckAddress: "Dirección", ckFloor: "Piso", ckUnit: "Unidad", ckHowToArrive: "Cómo llegar", ckMaps: "Google Maps", ckWaze: "Waze", ckArrival: "Al llegar", ckContactName: "Te recibe", ckCodeNote: "El acceso es con código digital. Encontrarás tu código en la misma plataforma donde hiciste la reserva (Airbnb, Booking, etc.).", ckCheckoutTitle: "Tu check-out", ckCheckoutSteps: ["Avísanos en el momento de tu salida.", "Deja la tarjeta o llave en el mismo lugar donde las encontraste al ingresar.", "Nuestro equipo de limpieza llega a las 11:00 a.m. para preparar el espacio."], ckCheckoutFee: "Una tarjeta o llave no devuelta tiene un costo de reposición de $50.",
