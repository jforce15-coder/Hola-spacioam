...
const T = {
  es: {
    ...
    ckEarlyLate: "¿Necesitas ajustar tus horarios?", ckEarly: "Solicitar early check-in", ckLate: "Solicitar late check-out", ckFlexNote: "Sujeto a disponibilidad. Lo revisamos y te confirmamos.",
  ...
  en: {
    ...
    ckEarlyLate: "Need to adjust your times?", ckEarly: "Request early check-in", ckLate: "Request late check-out", ckFlexNote: "Subject to availability. We'll review and confirm.",
